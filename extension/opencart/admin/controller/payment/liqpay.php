...
class LiqPay extends \Opencart\System\Engine\Controller {
    ...
    public function index(): void {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/opencart/payment/liqpay', 'user_token=' . $this->session->data['user_token'])
        ];
        ...
        $this->response->setOutput($this->load->view('extension/opencart/payment/liqpay', $data));
    }
    ...
    public function save(): void {
        ...
        if (!$this->user->hasPermission('modify', 'extension/opencart/payment/liqpay')) {
